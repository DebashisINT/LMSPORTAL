...
{
    public partial class Branch_Correspondance : ERP.OMS.ViewState_class.VSPage
    {
        ...
        public string brId = string.Empty;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
           ...
           {
               brId = Convert.ToString(Request.QueryString["brId"]);
           }
            ...
            if (!IsPostBack)
            {
                //Session["KeyVal_InternalID_New"] = 0;
        ...
        protected void AddressGrid_CellEditorInitialize(object sender, ASPxGridViewEditorEventArgs e)
        {
            ...
            if (e.Column.FieldName == "contactperson")
            {
