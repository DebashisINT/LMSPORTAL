    ...
    public partial class management_Master_BranchAddEdit : ERP.OMS.ViewState_class.VSPage
    {
            ...
            try
            {
                ...
                if (Convert.ToString(Request.QueryString["id"]) == "ADD")
                {
                    ...
                    else
                    {
                        ...
                        if (noofRows > 0)
                        {
                            ...
                            if (udfTable != null)
                                Session["UdfDataOnAdd"] = reCat.insertRemarksCategoryAddMode("Br", NewId, udfTable, Convert.ToString(Session["LMSuserid"]));
                ...
                else
                {
                    ...
                    if (count1[0, 0] == "n")
                    {
                        ...
                        //oDBEngine.SetFieldValue("tbl_master_branch", "branch_code ='" + Convert.ToString(txtCode.Text).Trim() + "',branch_parentId='" + cmbParentBranch.SelectedItem.Value + "',branch_description='" + Convert.ToString(txtBranchDesc.Text).Trim() + "',branch_address1='" + Convert.ToString(txtAddress1.Text).Trim() + "',branch_address2='" + Convert.ToString(txtAddress2.Text).Trim() + "',branch_address3='" + Convert.ToString(txtAddress3.Text).Trim() + "',branch_country='" + txtCountry_hidden.Value + "',branch_state='" + txtState_hidden.Value + "',branch_city='" + txtCity_hidden.Value + "',branch_pin='" + Convert.ToString(HdPin.Value) + "', branch_phone='" + Convert.ToString(txtPhone.Text).Trim() + "', branch_type ='" + cmbBranchType.SelectedItem.Value + "',branch_regionid='" + cmbBranchRegion.SelectedItem.Value + "' , branch_head='" + txtBranchHead_hidden.Value + "',branch_contactPerson='" + Convert.ToString(txtContPerson.Text).Trim() + "',branch_cpPhone='" + Convert.ToString(txtContPhone.Text).Trim() + "',branch_cpEmail='" + Convert.ToString(txtContEmail.Text).Trim() + "', branch_Fax='" + Convert.ToString(txtFax.Text).Trim() + "' ,LastModifyUser='" + Convert.ToString(Session["LMSuserid"]) + "',LastModifyDate=getdate() ,branch_area='" + hdLstArea.Value + "',branch_GSTIN='" + GSTIN + "',branch_MainAccount='" + Convert.ToString(hdlstMainAccount.Value) + "',branch_CIN='" + txtCIN.Text + "',branch_CINdt='" + txtCINVdate.Text + "'", " branch_ID=" + Request.QueryString["id"] + "");
        ...
        protected void ASPxComboBox1_Callback(object source, CallbackEventArgsBase e)
        {
            ...
            if (txtBrokername.Text.Trim() == "")
                brokertrade.Text = "";
            //Values = "'" + Comp + "','" + Exch + "','" + Session["KeyVal_InternalID"].ToString() + "','" + terminalID.Text + "','" + PTer + "','" + CtClVend + "','" + CtclID.Text + "','" + ContactName.Text + "','" + CMode.Text + "','" + activation + "','" + deactivation + "','" + MappingID.Text + "','" + ProTrade.Text + "','" + ClientTrade.Text + "','" + AllTrade.Text + "','" + Session["LMSuserid"].ToString() + "','" + oDBEngine.GetDate().ToString() + "','" + brokertrade.Text.ToString().Trim() + "'";
            Values = "'" + Comp + "','" + Exch + "','" + Session["KeyVal_InternalID"].ToString() + "','" + terminalID.Text + "','" + PTer + "','" + CtClVend + "','" + CtclID.Text + "','" + ContactName.Text + "','" + CMode.Text + "','" + activation + "','" + deactivation + "','" + MappingID.Text + "','" + ProTrade.Text + "','" + ClientTrade.Text + "','" + AllTrade.Text + "','" + Session["LMSuserid"].ToString() + "','" + oDBEngine.GetDate().ToString() + "','" + brokertrade.Text.ToString().Trim() + "'";
                ...
                if (BID[0, 0] != "n")
                {
                    ...
                    Set TradingTerminal_CompanyID='" + Comp + "',TradingTerminal_ExchangeSegmentID='" + Exch +
                         "',TradingTerminal_TerminalID='" + terminalID.Text + "',TradingTerminal_ParentTerminalID='" + PTer +
                             ...
                             "',Tradingterminal_BrokerId='" + Convert.ToString(brokertrade.Text).Trim() + "',TradingTerminal_ModifyUser='" + Convert.ToString(Session["LMSuserid"]) +
