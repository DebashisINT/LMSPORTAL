...
namespace BusinessLogicLayer
{
   public class PurchaseInvoiceBL
   {
       ...
       //PopulateVendorProductTaxDataOnLoad(Convert.ToString(Session["LMSLastCompany"]), Convert.ToString(Session["LastFinYear1"]), Convert.ToString(Session["LMSuserbranchID"]), Convert.ToString(ddlInventory.SelectedItem.Value), DateTime.Now.ToString("yyyy-MM-dd"), Convert.ToString(ddl_TdsScheme.Value));
       ...
       //Convert.ToString(Session["LMSLastCompany"]), Convert.ToString(Session["LastFinYear1"]), Convert.ToString(Session["LMSuserbranchID"]), Convert.ToString(ddlInventory.SelectedItem.Value), DateTime.Now.ToString("yyyy-MM-dd"), Convert.ToString(ddl_TdsScheme.Value)
