...
namespace BusinessLogicLayer.SalesmanTrack
{
    public class Dashboard
    {
        ...
        public DataTable GetSalesManVisitDetails(string empcode)
        {
            ...
            proc.AddPara("@user_id", Convert.ToString(HttpContext.Current.Session["LMSuserid"]));
        ...
        //    DataTable DashboardTable = Dbengine.GetDataTable("select ACTION,COUNT(*) Count from FTSDASHBOARD_REPORT   WHERE USERID='" + Convert.ToString(HttpContext.Current.Session["LMSuserid"]) + "' group by ACTION");
